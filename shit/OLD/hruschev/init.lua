...
for i, state in ipairs(CORN_SPROUT_STATES) do
	...
	drawtype = "plantlike",
	tile_images = {"corn_sprout_" .. state .. ".png"},
...
for i, state in ipairs(CORN_COB_STATES) do
	...
	drawtype = "plantlike",
	tile_images = {"corn_sprout_cob_" .. state .. ".png"},
	...
	drawtype = "plantlike",
	tile_images = {"corn_sprout_cob_5.png"},
	...
	material = minetest.digprop_constanttime(0.3),
	furnace_burntime = 2,
	dug_item = 'craft "hruschev:corn_cob" 1',
	wall_mounted = false,
