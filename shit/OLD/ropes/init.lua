...
minetest.register_craftitem('ropes:string', {
	image = "string.png",
...
minetest.register_craft({
    output = 'node "ropes:rope" 1',
    recipe = {
    	{'craft "ropes:string"','craft "ropes:string"','craft "ropes:string"'},
    	{'craft "ropes:string"','craft "ropes:string"','craft "ropes:string"'},
    	{'craft "ropes:string"','craft "ropes:string"','craft "ropes:string"'},
    }
})
...
minetest.register_craft({
    output = 'craft "ropes:string" 3',
    recipe = {
        {'craft "flowers:cotton"'},
        {'craft "flowers:cotton"'},
        {'craft "flowers:cotton"'},
    }
})
